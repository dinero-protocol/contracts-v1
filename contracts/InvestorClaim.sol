...
contract InvestorClaimV2 {
    ...
    /**
     *  @notice view BTRFLY claimable for address. PRINCIPAL decimals (18).
    ...
    /**
     *  @notice view BTRFLY claimed by address. BTRFLY decimals (9).
     *  @param _address address
     *  @return uint
     */
    ...
    /**
     *  @notice view circulating supply of BTRFLY
